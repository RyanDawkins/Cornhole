...
import ryanddawkins.com.cornhole.data.RandomString;

/**
 * Created by ryan on 12/21/15.
 */
public class OnlineFragment extends BaseFragment implements GameState {
...
//    protected SegmentedGroup playersNumGroup;
    ...
    public OnlineFragment() {
        ...
        this.newGame.setGameString(randomString.nextString().replace("", " ").trim());
    }
